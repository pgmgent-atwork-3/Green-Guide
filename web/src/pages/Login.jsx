      ...
      <div className="min-h-screen">
        <main>
          <div className="mx-auto max-w-7xl py-36 sm:px-20 lg:px-40">
            {/* Main content */}
            <h1 className="pb-6 text-4xl font-bold tracking-tight text-primary-100 primary-font">
              Login
            </h1>
              ...
              <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                <div className="grid grid-cols-4 gap-6">
                  <div className="col-span-2 sm:row-span-2">
                    <img
                      src="https://opendoodles.s3-us-west-1.amazonaws.com/plant.svg"
                      alt=""
                    />
                  </div>
                  <Formik
                      ...
                      <Form onSubmit={handleSubmit} action="#" method="POST">
                        <div className="col-span-2 sm:row-span-2">
                          ...
                          <input
                            ...
                            value={values.email}
                          />
                          <small className="pb-4 block text-accent-100">
