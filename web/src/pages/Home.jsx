                    ...
                    <div className="sm:grid-cols-1">
                        <div id="about" className="md:grid-cols-2 mb-40 p-2 grid gap-2 ">
                            <div className="m-auto px-12">
                                ...
                                <p className="pb-4">Green Guide is your green guide through Ghent. The only, real way to finally discover all those sustainable and environmentally conscious addresses in Ghent. </p> 
                                <p className="pb-4 font-bold text-secondary-100">Together we can further develop our city into a truly green environment!</p> 
                                <p className="pb-4">This project is also a beautiful reflection of the unique cooperation between all higher education institutions in Ghent, a truly unique project that has brought together many hemispheres.</p>
                            </div>
                            <div>
                                <img
                    ...
                    <div className="sm:grid-cols-1">
                        <div id="business" className="md:grid-cols-2 mb-40 p-2 grid gap-2">
                            <div className="m-auto px-12">
                                ...
                                <p className="pb-4">The Green Guide is suitable for any company within Ghent that is committed to a greener living environment.</p> 
                                <p className="pb-4">Together we want to give these companies a helping hand and inform everyone that they are taking a step in the right direction. And this becomes visible thanks to the Green Guide label, to which every participating company is entitled.</p> 
                                <p className="pb-4">If you would like to be part of this, you can simply register below. If you meet all the participating criteria, you will soon also be among the sustainable addresses.</p>
                                <p className="pb-4 font-bold text-secondary-100">We look forward to welcoming you to our green guide.</p>
                            </div>
                            <div>
                                <img
                                    className="bg-cover h-168 w-184"
